...
## 41.结构体变量之间通过变量名相互直接赋值，但是数组与字符串之间不能通过变量名来直接赋值
## 42.链表中的节点与下一节点在每一步中的地址为什么一定要判断清楚（很多不是不会，而是操作时没有判断清楚每一步的next和当前节点值，例如：P330习题6和7）
## 43.![avatar](file_structure.png)
## 44.文件操作相关函数
|函数|功能|
|---|---|
|
